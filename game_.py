...
def rectangles_collide(monster, player):
    """
    Check if two rectangles collide.

    Parameters:
    - rect1: pygame.Rect object representing the first rectangle.
    - rect2: pygame.Rect object representing the second rectangle.

    Returns:
    - True if the rectangles collide (overlap), False otherwise.
    """
    return monster.colliderect(player)
...
def playgame():
    ...
    monster = pygame.transform.scale(monster_image, (50, 50))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_LEFT:
                    ...
                    gameExit = True
                if 0 < new_x < 320 and 0 < new_y < 320:
                    x = new_x
                    y = new_y
                    window.fill((0, 0, 0))
                    window.blit(player, (x, y))
